...
const Home = () => {
  ...
  return (
    <section>
      ...
      <div className="rounded-bl-boxes rounded-br-boxes bg-cream px-12 lg:px-20 pt-5 pb-14 text-textColor">
        ...
        {!loading && (
          <div className="mt-5 flex justify-between flex-wrap gap-4 xl:gap-2">
